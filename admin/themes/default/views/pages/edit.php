...
if (isset($_SESSION['IS_ADMIN']) && $_SESSION['IS_ADMIN']=='1'){
	...
	$main_msg= $pages['Pages']['content'];
	
	$user_created = $pages['Pages']['user_created'];
	$date_created = date("M d Y",strtotime($pages['Pages']['date_created']));
	...
	<form name='adminform' method="POST" action='<?php echo BASE_PATH."/admin/pages/edit/".$id ?>' onsubmit='return validate_form(this);'>
