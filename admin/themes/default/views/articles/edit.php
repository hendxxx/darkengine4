...
if (isset($_SESSION['IS_ADMIN']) && $_SESSION['IS_ADMIN']=='1'){	
	...
	$subject = $articles['Articles']['subject'];
	$tags = $articles['Articles']['tags'];
	$front = $articles['Articles']['front'];
	$main_msg= $articles['Articles']['content'];
	
	$user_created = $articles['Articles']['user_created'];
	$date_created = date("M d Y",strtotime($articles['Articles']['date_created']));
	...
	<form name='adminform' method="POST" action='<?php echo BASE_PATH."/admin/articles/edit/".$id ?>' onsubmit='return validate_form(this);'>
