...
if (isset($_SESSION['IS_ADMIN']) && $_SESSION['IS_ADMIN']=='1'){
	...
	$user_created = $links['Links']['user_created'];
	$date_created = date("M d Y",strtotime($links['Links']['date_created']));
	...
	<form enctype='multipart/form-data' name='adminform' method="POST" action='<?php echo BASE_PATH."/admin/links/edit/".$id ?>' onsubmit='return validate_form(this);'>
