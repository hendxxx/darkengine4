		...
		<form name='commentform' method="POST" action='<?php echo BASE_PATH."/contact/send/"?>' onsubmit='return validate_form(this);'>
			...
			<tbody>
				<tr>
					...
					<td>: <input type="text" maxlength="60" name="name" id="name" size="30" value="Anonymous"  /></td>
				</tr>
				<tr>
					<td> <label for="subject">Email</label></td>
					<td>: <input type="text" maxlength="60" name="email" id="email" size="30" value=""  /></td>
				</tr>
				<tr>
					<td> <label for="subject">Subject</label></td>
					<td>: <input type="text" maxlength="60" name="subject" id="subject" size="30" value="No Subject"  /></td>
				</tr>
				<tr>
					<td colspan="2">
					<textarea cols="60" rows="15" name="comment" id="comment" style="width:500px;height:150px;"></textarea>
					</td>
				</tr>
				<tr>
