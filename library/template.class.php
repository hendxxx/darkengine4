...
class Template {
    ...
    function render($_page = null) {
		...
		if ($_page == null)
        	include (ROOT . DS . 'application' . DS . 'themes' . DS . THEMES  . DS .'views'. DS. $this->_controller . DS . $this->_action . '.php');		 
		else
			include (ROOT . DS . 'application' . DS . 'themes' . DS . THEMES  . DS .'views'. DS. $_page);	
